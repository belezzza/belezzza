...
<p align="center">
  Masaüstü yazılım mimarileri, sistem performans optimizasyonu ve modern web çözümleri üzerine çalışan bir yazılım mühendisliği öğrencisiyim. Ağırlıklı olarak C++ (Qt), Python, Rust ve Next.js ekosistemlerinde projeler inşa ediyorum.
</p>
...
- **Treadix:** C++ ve Qt ile yazılmış, barkod tarama entegrasyonuna sahip, Supabase ve Prisma altyapılı lastik stok yönetim yazılımı.
- **mcp-vector-search:** ChromaDB ve Python tabanlı, Model Context Protocol (MCP) standartlarında çalışan yerel vektör arama sunucusu.
- **Bluesky Archiver:** AT Protocol API'si üzerinden gönderi ve medyaları kronolojik olarak arşivleyen Python/Tkinter aracı.
